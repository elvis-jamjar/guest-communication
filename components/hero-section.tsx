        ...
        <div
            ...
            <div className="relative w-full z-10 flex flex-col h-full min-h-screen">
                ...
                <div className={cn("flex-1 flex flex-col justify-center pt-32 md:pt-40")}>
                    ...
                    <div className="px-8 md:px-16 relative z-10 py-8">
                        {/* Main heading */}
                        <h1 className="text-white font-semibold text-center md:text-left text-5xl md:text-7xl leading-snug mb-6 drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)]">
                            From Bridges
                            <br />
                            to Breakthroughs
                        </h1>
